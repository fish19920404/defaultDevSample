package com.zyjr.emergencylending.base.http.okhttp.request;

import android.text.TextUtils;

import com.zyjr.emergencylending.base.http.okhttp.OkHttpUtils;
import com.zyjr.emergencylending.base.http.okhttp.utils.Exceptions;
...
public class OtherRequest extends OkHttpRequest
{
    ...
    protected Request buildRequest(RequestBody requestBody)
    {
        ...
        }else if (method.equals(OkHttpUtils.METHOD.OPTIONS)){
            builder.method(OkHttpUtils.METHOD.OPTIONS, requestBody);
        }
