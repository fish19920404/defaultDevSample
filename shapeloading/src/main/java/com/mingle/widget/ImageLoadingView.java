...
public class ImageLoadingView extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.image_load_view, null);
...
//            ObjectAnimator objectAnimator1 = ObjectAnimator.ofFloat(mShapeLoadingView, "rotation", 0, -120);
